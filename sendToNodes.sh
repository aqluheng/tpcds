...
sudo -u emr-user scp -r -o StrictHostKeyChecking=no $file core-1-1:
sudo -u emr-user scp -r -o StrictHostKeyChecking=no $file core-1-2:
sudo -u emr-user scp -r -o StrictHostKeyChecking=no $file core-1-3:
